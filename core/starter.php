                                        ...
                                        <div class="pe-3" data-simplebar style="max-height: 287px;">
                                            <a href="#" class="text-body d-block">
                                                <div class="d-flex py-3">
                                                    <div class="flex-shrink-0 me-3 align-self-center">
                                                        <img class="rounded-circle avatar-xs" alt="" src="../core/assets/images/users/avatar-2.jpg">
                                                    </div>
                                            ...
                                            <a href="#" class="text-body d-block">
                                                <div class="d-flex py-3">
                                                    <div class="flex-shrink-0 me-3 align-self-center">
                                                        <img class="rounded-circle avatar-xs" alt="" src="../core/assets/images/users/avatar-3.jpg">
                                                    </div>
                                                    <div class="flex-grow-1 overflow-hidden">
                                                ...
                                                <div class="d-flex py-3">
                                                    <div class="flex-shrink-0 me-3 align-self-center">
                                                        <img class="rounded-circle avatar-xs" alt=""
                                                            src="../core/assets/images/users/avatar-4.jpg">
                                                    </div>
                                                    <div class="flex-grow-1 overflow-hidden">
                                            ...
                                            <table class="table table-centered table-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="../core/assets/images/users/avatar-2.jpg" alt="user" class="avatar-xs rounded-circle" />
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="../core/assets/images/users/avatar-3.jpg" alt="user" class="avatar-xs rounded-circle" />
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="../core/assets/images/users/avatar-6.jpg" alt="user" class="avatar-xs rounded-circle" />
                                                        </td>
                                                        <td>
