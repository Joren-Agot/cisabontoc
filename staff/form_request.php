...
<?php include 'staff-script/request_script.php'; ?>
...
<script>
    ...
    document.querySelectorAll('.nav-link').forEach(function(link) {
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="btn-group ms-2">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a class="dropdown-item" id="sa-success" href="#" onclick="updateStatus(<?php echo $row['id']; ?>, 'Delivered')">Approve</a></li>
                                ...
                                <div class="card-t" data-request-id="<?php echo $jobOrderId; ?>">
                                    <div class="card-body">
                                        ...
                                        <div class="btn-group ms-2">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" id="sa-success" href="#" onclick="updateStatus(<?php echo $row['id']; ?>, 'Processed')">Approve</a></li>
                                                <li><a class="dropdown-item" href="#" onclick="updateStatus(<?php echo $row['id']; ?>, 'Declined')">Decline</a></li>
                                            </ul>
                                        </div>
                                    </div>
        ...
        <!-- END layout-wrapper -->
<?php include 'staff-script/request_card.php'; ?>
